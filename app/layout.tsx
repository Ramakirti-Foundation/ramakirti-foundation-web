    ...
    <html lang="en" className={`${atkinson.variable}`}>
      ...
      <body suppressHydrationWarning={true} className={`${atkinson.variable} font-sans antialiased text-[19px]`}>
        ...
        <a 
          ...
          className="fixed z-50 bg-[#25D366] text-white p-3 md:p-4 rounded-2xl shadow-lg hover:-translate-y-1 hover:shadow-xl hover:bg-[#1FAF53] transition-all duration-300 flex items-center justify-center cursor-pointer group whatsapp-fab"
          aria-label="Chat with us on WhatsApp"
        >
          <svg
            xmlns="http://www.w3.org/2000/svg"
            viewBox="0 0 24 24"
            className="fill-current text-white whatsapp-fab-icon"
          >
