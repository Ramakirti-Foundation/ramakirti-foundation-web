      ...
      <main className="pt-20">
        ...
        <section className="py-24 px-6">
          <div className="max-w-[1200px] mx-auto grid lg:grid-cols-[1.2fr_1fr] gap-16 items-start">
            ...
            <div>
              ...
              <div className="space-y-6">
                {[
                  ...
                  { icon: '🕐', title: 'Office Hours', items: [{ content: 'Monday to Sunday, 9 AM – 9 PM IST', href: undefined }] },
              ...
              <div className="mt-10 p-6 bg-[#F0FCF4] border border-[rgba(37,211,102,.2)] rounded-2xl">
                ...
                <a
                  href="https://wa.me/918851502840?text=Hi%20Ramakirti%20Foundation%2C%20I%20would%20like%20to%20know%20more%20about%20your%20work%20"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="whatsapp-support-btn no-underline hover:text-white"
            ...
            <div>
              {status === 'success' ? (
                <div className="bg-white rounded-3xl p-5 md:p-10 shadow-[0_4px_32px_rgba(101,26,22,.1)] border border-[rgba(101,26,22,.08)] text-center max-w-full overflow-hidden">
                  <div className="text-[64px] mb-4">✅</div>
                  <h3 className="font-[family-name:var(--font-plus-jakarta)] font-bold text-[24px] text-[#651A16] mb-3">Message Sent!</h3>
                  <p className="text-gray-500 break-words">Thank you, {form.name.split(' ')[0]}. We&apos;ll get back to you at <strong className="break-all">{form.email}</strong> within 24 hours.</p>
                </div>
              ) : (
