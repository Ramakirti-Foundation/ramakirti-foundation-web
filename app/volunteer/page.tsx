...
export default async function VolunteerPage() {
  let volunteers: any[] = [];
  try {
    volunteers = await db.teamMember.findMany({
        ...
        <section className="py-24 bg-[#FDF8F7]">
          <div className="max-w-[1280px] mx-auto px-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
              {volunteers.map((vol) => (
                <div key={vol.id} className="volunteer-card bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 flex flex-col">
